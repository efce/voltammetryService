...
class plotMaker {
	...
	function RegularPlot($mes_id)
	{
		...
		$plot->SetFontTTF('x_title', 'verdanab.ttf', 12);
		$plot->SetFontTTF('y_title', 'verdanab.ttf', 12);
		$plot->SetFontTTF('title', 'verdanab.ttf', 13);
		$plot->SetFontTTF('y_label', 'verdana.ttf', 10);
		$plot->SetFontTTF('x_label', 'verdana.ttf', 10);
		$plot->SetFontTTF('legend', 'verdana.ttf', 10);
